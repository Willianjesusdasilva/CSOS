...
`zig build test` conclui `37/37` etapas e `171/171` testes aprovados; um boot QEMU limitado também voltou a alcançar
...
e `171/171` testes, e o boot QEMU chegou a `Linux PIE userspace ready`. A
