...
`zig build test` conclui `17/17` etapas e `33/33` testes aprovados; um boot QEMU limitado também voltou a alcançar
...
e `33/33` testes, e o boot QEMU chegou a `CSOS graphical session ready`. A
