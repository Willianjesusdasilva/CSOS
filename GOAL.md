...
`zig build test` conclui `17/17` etapas e `32/32` testes aprovados; um boot QEMU limitado também voltou a alcançar
...
e `32/32` testes, e o boot QEMU chegou a `CSOS graphical session ready`. A
