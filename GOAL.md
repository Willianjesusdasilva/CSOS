...
`zig build test` conclui `37/37` etapas e `117/117` testes aprovados; um boot QEMU limitado também voltou a alcançar
...
e `117/117` testes, e o boot QEMU chegou a `CSOS graphical session ready`. A
