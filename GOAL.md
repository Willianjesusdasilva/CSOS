...
`zig build test` conclui `29/29` etapas e `95/95` testes aprovados; um boot QEMU limitado também voltou a alcançar
...
e `95/95` testes, e o boot QEMU chegou a `CSOS graphical session ready`. A
