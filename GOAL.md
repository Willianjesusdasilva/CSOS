...
1. Implementar a identidade PCI Linux que `drmGetDevice2` exige para associar `/dev/dri/renderD128` à GPU física, continuar a auditoria do RADV/libdrm e então validar command submission no caminho AMD GFX11 em hardware real.
