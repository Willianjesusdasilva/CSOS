...
`zig build test` conclui `29/29` etapas e `92/92` testes aprovados; um boot QEMU limitado também voltou a alcançar
...
e `92/92` testes, e o boot QEMU chegou a `CSOS graphical session ready`. A
