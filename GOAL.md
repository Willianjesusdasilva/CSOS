...
`zig build test` conclui `17/17` etapas e `34/34` testes aprovados; um boot QEMU limitado também voltou a alcançar
...
e `34/34` testes, e o boot QEMU chegou a `CSOS graphical session ready`. A
