...
`zig build test` conclui `33/33` etapas e `105/105` testes aprovados; um boot QEMU limitado também voltou a alcançar
...
e `105/105` testes, e o boot QEMU chegou a `CSOS graphical session ready`. A
