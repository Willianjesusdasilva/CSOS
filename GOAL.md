...
`zig build test` conclui `39/39` etapas e `182/182` testes aprovados; um boot QEMU limitado também voltou a alcançar
...
Verificação mais recente em 2026-09-07: `zig build test` concluiu `39/39` etapas
e `182/182` testes, e o boot QEMU chegou a `Linux PIE userspace ready`. A
