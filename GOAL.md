...
1. Auditar a sequência real de inicialização e submissão do RADV/libdrm contra os ioctls AMDGPU restantes, corrigir o primeiro contrato ainda incompatível e então validar command submission no caminho AMD GFX11 em hardware real.
