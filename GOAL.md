...
`zig build test` conclui `31/31` etapas e `101/101` testes aprovados; um boot QEMU limitado também voltou a alcançar
...
e `101/101` testes, e o boot QEMU chegou a `CSOS graphical session ready`. A
