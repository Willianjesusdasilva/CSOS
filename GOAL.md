...
`zig build test` conclui `33/33` etapas e `106/106` testes aprovados; um boot QEMU limitado também voltou a alcançar
...
e `106/106` testes, e o boot QEMU chegou a `CSOS graphical session ready`. A
