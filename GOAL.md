...
- [ ] **M14 — GPU AMD/NVIDIA + Vulkan:** parcial. A preparação AMD GFX11, a ABI DRM e o snapshot físico de CUs ativos possuem implementação e testes de host, mas clocks/memória completos, execução Radeon real e triângulo RADV ainda faltam. NVIDIA/NVK vem depois do primeiro triângulo AMD e também exige validação real.
...
1. Completar clocks e memória físicos do `AMDGPU_INFO_DEV_INFO`, command submission e RADV no caminho AMD GFX11.
