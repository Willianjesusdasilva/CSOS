...
`zig build test` conclui `29/29` etapas e `93/93` testes aprovados; um boot QEMU limitado também voltou a alcançar
...
e `93/93` testes, e o boot QEMU chegou a `CSOS graphical session ready`. A
