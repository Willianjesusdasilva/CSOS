...
`zig build test` conclui `35/35` etapas e `109/109` testes aprovados; um boot QEMU limitado também voltou a alcançar
...
e `109/109` testes, e o boot QEMU chegou a `CSOS graphical session ready`. A
