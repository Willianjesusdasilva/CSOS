...
`zig build test` conclui `33/33` etapas e `103/103` testes aprovados; um boot QEMU limitado também voltou a alcançar
...
e `103/103` testes, e o boot QEMU chegou a `CSOS graphical session ready`. A
