...
`zig build test` conclui `41/41` etapas e `183/183` testes aprovados; um boot QEMU limitado também voltou a alcançar
...
e `183/183` testes, e o boot QEMU chegou a `Linux PIE userspace ready`. A
