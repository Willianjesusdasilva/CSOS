...
`zig build test` conclui `37/37` etapas e `150/150` testes aprovados; um boot QEMU limitado também voltou a alcançar
...
e `150/150` testes, e o boot QEMU chegou a `Linux PIE userspace ready`. A
