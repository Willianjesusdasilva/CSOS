...
`zig build test` conclui `35/35` etapas e `108/108` testes aprovados; um boot QEMU limitado também voltou a alcançar
...
e `108/108` testes, e o boot QEMU chegou a `CSOS graphical session ready`. A
