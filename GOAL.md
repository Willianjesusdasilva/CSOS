...
`zig build test` conclui `37/37` etapas e `178/178` testes aprovados; um boot QEMU limitado também voltou a alcançar
...
e `178/178` testes, e o boot QEMU chegou a `Linux PIE userspace ready`. A
