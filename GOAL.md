...
`zig build test` conclui `29/29` etapas e `100/100` testes aprovados; um boot QEMU limitado também voltou a alcançar
...
e `100/100` testes, e o boot QEMU chegou a `CSOS graphical session ready`. A
