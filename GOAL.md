...
`zig build test` conclui `17/17` etapas e `35/35` testes aprovados; um boot QEMU limitado também voltou a alcançar
...
e `35/35` testes, e o boot QEMU chegou a `CSOS graphical session ready`. A
