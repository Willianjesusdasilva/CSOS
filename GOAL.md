...
`zig build test` conclui `37/37` etapas e `124/124` testes aprovados; um boot QEMU limitado também voltou a alcançar
...
Verificação mais recente em 2026-09-07: `zig build test` concluiu `37/37` etapas
e `124/124` testes, e o boot QEMU chegou a `CSOS graphical session ready`. A
