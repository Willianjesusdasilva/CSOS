...
`zig build test` conclui `27/27` etapas e `87/87` testes aprovados; um boot QEMU limitado também voltou a alcançar
...
e `87/87` testes, e o boot QEMU chegou a `CSOS graphical session ready`. A
