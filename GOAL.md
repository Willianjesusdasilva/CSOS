...
`zig build test` conclui `27/27` etapas e `89/89` testes aprovados; um boot QEMU limitado também voltou a alcançar
...
e `89/89` testes, e o boot QEMU chegou a `CSOS graphical session ready`. A
