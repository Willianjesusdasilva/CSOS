...
`zig build test` conclui `17/17` etapas e `25/25` testes aprovados; um boot QEMU limitado também voltou a alcançar
...
e `25/25` testes, e o boot QEMU chegou a `CSOS graphical session ready`. A
