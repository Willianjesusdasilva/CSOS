...
`zig build test` conclui `17/17` etapas e `37/37` testes aprovados; um boot QEMU limitado também voltou a alcançar
...
e `37/37` testes, e o boot QEMU chegou a `CSOS graphical session ready`. A
