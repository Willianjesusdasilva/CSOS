...
`zig build test` conclui `37/37` etapas e `135/135` testes aprovados; um boot QEMU limitado também voltou a alcançar
...
e `135/135` testes, e o boot QEMU chegou a `Linux PIE userspace ready`. A
