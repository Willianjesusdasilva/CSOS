...
`zig build test` conclui `37/37` etapas e `112/112` testes aprovados; um boot QEMU limitado também voltou a alcançar
...
e `112/112` testes, e o boot QEMU chegou a `CSOS graphical session ready`. A
