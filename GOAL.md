...
`zig build test` conclui `37/37` etapas e `151/151` testes aprovados; um boot QEMU limitado também voltou a alcançar
...
e `151/151` testes, e o boot QEMU chegou a `Linux PIE userspace ready`. A
