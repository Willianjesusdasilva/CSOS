...
`zig build test` conclui `41/41` etapas e `188/188` testes aprovados; um boot QEMU limitado também voltou a alcançar
...
e `188/188` testes, e o boot QEMU chegou a `Linux PIE userspace ready`. A
