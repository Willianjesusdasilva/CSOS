...
1. Adaptar `AMDGPU_CS` às submissões RADV com múltiplos chunks IB GFX, preservando validação individual de engine, flags, limites, GPUVA e residência; continuar a auditoria dos ioctls e então validar command submission no caminho AMD GFX11 em hardware real.
