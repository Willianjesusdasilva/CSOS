...
`zig build test` conclui `37/37` etapas e `133/133` testes aprovados; um boot QEMU limitado também voltou a alcançar
...
e `133/133` testes, e o boot QEMU chegou a `CSOS graphical session ready`. A
