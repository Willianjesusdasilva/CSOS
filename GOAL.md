...
`zig build test` conclui `37/37` etapas e `121/121` testes aprovados; um boot QEMU limitado também voltou a alcançar
...
e `121/121` testes, e o boot QEMU chegou a `CSOS graphical session ready`. A
