...
pub const Element = struct { kind: Kind, text: []const u8, target: []const u8 = "", accent: bool = false, muted: bool = false, danger: bool = false, color: ?u32 = null, checkbox: bool = false, checked: bool = false };
...
pub const Document = struct {
    ...
    pub fn isCheckbox(self: *const Document, index: usize) bool {
        return index < self.count and self.elements[index].kind == .input and self.elements[index].checkbox;
    }
