...
if ($LASTEXITCODE -ne 0) { throw 'HTML UI userspace compilation failed' }
& $output
if ($LASTEXITCODE -ne 0) { throw "HTML UI vertical slice failed with exit code $LASTEXITCODE" }
Write-Output 'HTML UI vertical slice passed'
